...
classifier_params = jaxtorch.pt.load(
    '/mnt/models/jax-clip/jpeg-classifier-72.pt')['params_ema']
...
image_fn, text_fn, clip_params, _ = clip_jax.load('/mnt/models/jax-clip/ViT-B/32')
vit32 = Perceptor(image_fn, text_fn, clip_params)
image_fn, text_fn, clip_params, _ = clip_jax.load('/mnt/models/jax-clip/ViT-B/16')
